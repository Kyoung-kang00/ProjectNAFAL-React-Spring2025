# FAF (For All For) 프로젝트 ## 프로젝트 개요 FAF는 프로그래밍 챌린지, 커뮤니티, 마켓플레이스를 제공하는 종합 플랫폼입니다. ## 기술 스택 - **Backend**: Spring Boot, MyBatis, MySQL - **Frontend**: React, Tailwind CSS - **Authentication**: Spring Security, OAuth2 ## 프로젝트 구조
FAF/
